...
public class SlotPulv extends Slot
{
    /** The player that is using the GUI where this slot resides. */
    private EntityPlayer thePlayer;
    private int field_75228_b;

    public SlotPulv(EntityPlayer par1EntityPlayer, IInventory par2IInventory, int par3, int par4, int par5)
    {
    ...
    protected void onCrafting(ItemStack par1ItemStack)
    {
        ...
        if (!this.thePlayer.worldObj.isRemote)
        {
            ...
            float var3 = PulvRecipes.crushing().getExperience(par1ItemStack);
            int var4;
